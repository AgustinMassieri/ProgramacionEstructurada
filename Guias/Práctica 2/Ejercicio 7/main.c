...
void cargarAlumnosAlArreglo(t_alumno alumnos[NA]){
    ...
    //Si se puede abrir el archivo
        ...
        for(indiceAlumnos = 0; fscanf(archivo, "%d,%[^,],%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d",
                       &alumnos[indiceAlumnos].legajo, alumnos[indiceAlumnos].nombre,&alumnos[indiceAlumnos].materias[0],
                       &alumnos[indiceAlumnos].materias[1],&alumnos[indiceAlumnos].materias[2],&alumnos[indiceAlumnos].materias[3],
                       &alumnos[indiceAlumnos].materias[4],&alumnos[indiceAlumnos].materias[5],&alumnos[indiceAlumnos].materias[6],
                       &alumnos[indiceAlumnos].materias[7],&alumnos[indiceAlumnos].materias[8],&alumnos[indiceAlumnos].materias[9],
                       &alumnos[indiceAlumnos].materias[10],&alumnos[indiceAlumnos].materias[11],&alumnos[indiceAlumnos].materias[12],
                       &alumnos[indiceAlumnos].materias[13],&alumnos[indiceAlumnos].materias[14],&alumnos[indiceAlumnos].materias[15],
                       &alumnos[indiceAlumnos].materias[16],&alumnos[indiceAlumnos].materias[17],&alumnos[indiceAlumnos].materias[18],
                       &alumnos[indiceAlumnos].materias[19],&alumnos[indiceAlumnos].materias[20],&alumnos[indiceAlumnos].materias[21],
                       &alumnos[indiceAlumnos].materias[22],&alumnos[indiceAlumnos].materias[23],&alumnos[indiceAlumnos].materias[24],
                       &alumnos[indiceAlumnos].materias[25],&alumnos[indiceAlumnos].materias[26],&alumnos[indiceAlumnos].materias[27],
                       &alumnos[indiceAlumnos].materias[28],&alumnos[indiceAlumnos].materias[29]) != EOF && indiceAlumnos < NA;
                        indiceAlumnos++){
                        }
